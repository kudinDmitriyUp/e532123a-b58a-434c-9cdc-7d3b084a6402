...
export const metadata: Metadata = {
  title: "Mumbai Beachside Realty - Luxury Sea View Properties",
  description: "Premium beachside properties in Mumbai with stunning sea views, modern amenities, and prime coastal locations. Find your dream home today.",
  keywords: "Mumbai real estate, beachside properties, sea view apartments, luxury homes Mumbai, coastal properties, premium real estate Mumbai",
  openGraph: {
    title: "Mumbai Beachside Realty - Luxury Sea View Properties",
    description: "Premium beachside properties in Mumbai with stunning sea views, modern amenities, and prime coastal locations.",
    siteName: "Mumbai Beachside Realty",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763242198204-vrhdowi4.jpg",
        alt: "Mumbai luxury beachside properties"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Mumbai Beachside Realty - Luxury Sea View Properties",
    description: "Premium beachside properties in Mumbai with stunning sea views, modern amenities, and prime coastal locations.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763242198204-vrhdowi4.jpg"]
  },
  robots: {
    index: true,
    follow: true
